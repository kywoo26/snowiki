...
@lru_cache(maxsize=1)
def normalized_records() -> tuple[NormalizedRecord, ...]:
    recorded_at = (
        datetime(2026, 4, 8, 12, 0, tzinfo=UTC).isoformat().replace("+00:00", "Z")
    )
    return (
        _normalized_record(
            record_id="fixtures/claude/basic.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/claude/with_tools.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/claude/with_attachments.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/claude/with_sidechains.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/claude/resumed.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/claude/large_output.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/opencode/basic.db",
        ...
        _normalized_record(
            record_id="fixtures/opencode/with_todos.db",
        ...
        _normalized_record(
            record_id="fixtures/opencode/with_diffs.db",
        ...
        _normalized_record(
            record_id="fixtures/opencode/with_reasoning.db",
        ...
        _normalized_record(
            record_id="fixtures/opencode/with_compaction.db",
        ...
        _normalized_record(
            record_id="fixtures/claude/secret_bearing.jsonl",
        ...
        _normalized_record(
            record_id="fixtures/secrets/test_api_keys.jsonl",
        ...
        _normalized_record(
            record_id="benchmarks/queries.json",
        ...
        _normalized_record(
            record_id="benchmarks/judgments.json",
        ...
        _normalized_record(
            record_id="session-yesterday-korean-english",
        ...
        _normalized_record(
            record_id="session-today-indexing",
...
@lru_cache(maxsize=1)
def compiled_pages() -> tuple[CompiledPage, ...]:
    return (
        _compiled_page(
            slug="mixed-language-overview",
